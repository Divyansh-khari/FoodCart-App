...
const FoodCart = ({id, name, img, price, desc,rating, handleToast}) => {
  const dispatch= useDispatch();


  return (
    <div className='font-bold w-[250px] bg-white p-3 flex flex-col rounded-lg gap-2'>
      <img src={img}
